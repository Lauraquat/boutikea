...
$(document).ready(function() {
    $('.checkbox').on('change', function() {
        ...
        if (is_it_checked == true) {
            $('.lq_product-details, .navbar').css('background-color', '#3a3a3a');
            $('.navbar a, .navbar h2').css('color', 'white');
            $('#quiSommesNous, #quiSommesNous h2, #quiSommesNous h3').css('color', 'white');
            $('#boutique h2, #boutique, #boutique a').css('color', 'white');
            $('.td_home-slider__slide--1,.td_home-slider__slide--2,.td_home-slider__slide--3').css('filter', 'grayscale(1)')
            $(document.body, '.navbar').css('background-color', 'var(--noir)');
        } else {
            $('.lq_product-details').removeAttr('style');
            $('.navbar').removeAttr('style');
            $('.navbar a, .navbar h2').removeAttr('style');
